...
const moveIntoMoreDropdown = (menu, navNode, prepend = false) => {
    ...
    if (navLink.classList.contains(Selectors.classes.dropdowntoggle)) {
        const dropdownmenu = navLink.parentNode.querySelector('.' + Selectors.classes.dropdownmenu);
        dropdownmenu.classList.add('pl-2');
    }
...
const moveOutOfMoreDropdown = (menu, navNode) => {
    ...
    if (navLink.classList.contains(Selectors.classes.dropdowntoggle)) {
        const dropdownmenu = navLink.parentNode.querySelector('.' + Selectors.classes.dropdownmenu);
        dropdownmenu.classList.remove('pl-2');
    }
