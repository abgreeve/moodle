...
$string['exportlogfordataprivacy'] = 'Include logs for data export requests';
$string['exportlogfordataprivacydetail'] = 'Include logs that relate to the user in data export requests made by users.';
