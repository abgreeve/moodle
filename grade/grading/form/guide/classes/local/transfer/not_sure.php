...
class not_sure implements definition_transfer {
    ...
    /**
     * This is a static function that is called by the advanced grading method factory to initialize the class.
     *
     * @return definition_transfer The class that is being initialized.
     */
    public static function init(): definition_transfer {
        return new self();
    }
