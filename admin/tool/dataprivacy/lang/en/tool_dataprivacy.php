...
$string['allcomponentsgood'] = 'All plugins implement Moodle\'s privacy API';
...
$string['filterresults'] = 'Filter report';
...
$string['requiresattentionareas'] = 'There are {$a} areas that do not implement the Moodle privacy API and should be addressed.';
...
$string['searchplaceholder'] = 'Search for a category or plugin';
$string['send'] = 'Send';
