...
$string['basicexporthelp'] = 'A grading form export format';
$string['basicexporttitle'] = 'Moodle basic export format';
$string['basicimporthelp'] = 'A grading form import format';
$string['basicimporttitle'] = 'Moodle basic import format';
...
$string['jsonimporterror'] = 'The contents of this file do not appear to be in a JSON format that can be decoded.';
