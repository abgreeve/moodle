...
class user_submission_actionmenu implements templatable, renderable {
    ...
    private $showedit;
    private $submission;
    private $teamsubmission;

    public function __construct($cmid, $showsubmit, $showedit, $submission = null, $teamsubmission = null) {
        $this->cmid = $cmid;
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        if ($this->showedit) {
            ...
            if ($status === ASSIGN_SUBMISSION_STATUS_REOPENED) {
                $url = new moodle_url('/mod/assign/view.php', ['id' => $this->cmid, 'action' => 'editprevioussubmission', 'sesskey' => sesskey()]);
                ...
                $url->param('action', 'editsubmission');
