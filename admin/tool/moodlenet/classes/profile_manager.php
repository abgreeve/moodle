...
class profile_manager {
     ...
     */
    public static function get_mnet_profile(int $userid): ?moodlenet_user_profile {
        global $CFG;
     ...
     */
    protected static function check_profile_category(int $categoryid = null): bool {
        global $DB;
     ...
     */
    protected static function set_category_name(string $categoryname): string {
        global $DB;
     ...
     */
    protected static function set_profile_field_name(string $fieldname): string {
        global $DB;
